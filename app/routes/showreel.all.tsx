...
export const meta: MetaFunction = () => {
  return [
    { title: "All Showreel | STUDIO–RO®" },
    { name: "description", content: "View all dance showreel videos from STUDIO–RO." },
  ];
};
...
export default function ShowreelAll() {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="marquee-container relative overflow-hidden h-20 bg-contrast mb-8">
          <div className="marquee absolute top-0 left-full whitespace-nowrap">
            <h1 className="text-white inline-block mr-8">All Showreel</h1>
            <h1 className="text-white inline-block mr-8">All Showreel</h1>
            <h1 className="text-white inline-block mr-8">All Showreel</h1>
            <h1 className="text-white inline-block mr-8">All Showreel</h1>
          </div>
        ...
        <div className="flex justify-center gap-4 mb-8">
          <a href="/showreel/all" className="btn inline-block">
            <span>All</span>
          </a>
