...
export const meta: MetaFunction = () => {
  return [
    { title: "Heels Showreel | STUDIO–RO®" },
    { name: "description", content: "View heels dance showreel videos from STUDIO–RO." },
  ];
};
...
export default function ShowreelHeels() {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="marquee-container relative overflow-hidden h-20 bg-contrast mb-8">
          <div className="marquee absolute top-0 left-full whitespace-nowrap">
            <h1 className="text-white inline-block mr-8">Heels Showreel</h1>
            <h1 className="text-white inline-block mr-8">Heels Showreel</h1>
            <h1 className="text-white inline-block mr-8">Heels Showreel</h1>
            <h1 className="text-white inline-block mr-8">Heels Showreel</h1>
          </div>
        ...
        <div className="flex justify-center gap-4 mb-8">
          ...
          <a href="/showreel/heels" className="btn inline-block">
            <span>Heels</span>
          </a>
          <a href="/showreel/commercial" className="btn btn--ghost inline-block">
